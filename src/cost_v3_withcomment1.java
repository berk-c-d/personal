...
public class cost_v3_withcomment1 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        */
        ...
        arr = SimulationMatrix_v3adapted(period, m, alphaSimulation, lambdaSimulation, unitCost, fixedCost, retailPrice, returnCredit, holdingCost, backorderCost, salvageValue,nresult ,S, sl, s, alpha, lambda, BigM, MM,  poissonDistProbability, binomialDistProbability,B0,B1,B2,B3);
    ...
    public static double[] SimulationMatrix_v3adapted(int period, int m, double alphaSimulation, double lambdaSimulation, int unitCost, int fixedCost, int retailPrice, int returnCredit, double holdingCost, double backorderCost, int salvageValue,int nresult ,int [] S,int sl, int s, double alpha, double lambda, int BigM, int MM,  double[] poissonDistProbability, double[][] binomialDistProbability,double[] B0,double[] B1,double[] B2,double[] B3) {
        ...
        for (int run = 0; run < nn; run++) {
            //arr = ProcessMatrix_v3adapted(period, m, alphaSimulation, lambdaSimulation, unitCost, fixedCost, retailPrice, returnCredit, holdingCost, backorderCost, salvageValue, nresult , S,sl, s, alpha, lambda, BigM, MM, poissonDistProbability, binomialDistProbability, B0,B1,B2,B3);
            //--------------------------------------------------processmatrixv3-------------------------------------------------------------------------------------------------------------------
            //double[] arr = new double[nresult];
            ...
            //----------------------------------------periodmatrix_v6 aşağı yerleştirildi
            double total;
            //int Z_bigSDouble = 0;xxx
            int SS = 0;
            double z_line;
            ...
            for (int i = 1; i < period-1; i++) {
                ...
                double total_;
                double total2_;
                //int Z_bigSDouble_ = 0;xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
                int SS_ = 0;
                double z_line_;
...
////////////////////////////////////////////////////////////////////////
    ...
    public static double[] ProcessMatrix_v3adapted(int period, int m, double alphaSimulation, double lambdaSimulation, int unitCost, int fixedCost, int retailPrice, int returnCredit, double holdingCost, double backorderCost, int salvageValue, int nresult ,int [] S,int sl, int s, double alpha, double lambda, int BigM, int MM,  double[] poissonDistProbability, double[][] binomialDistProbability,double[] B0,double[] B1,double[] B2,double[] B3) {
