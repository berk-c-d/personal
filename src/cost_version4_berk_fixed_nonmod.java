...
public class cost_version4_berk_fixed_nonmod {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //Intercept
        B0[0]=0;
        B0[1]=691.027463546519
        ;
        B0[2]=476.801132876845
        ;
        B0[3]=286.786774464158
        ;
        B0[4]=166.985347082954
        ;
        ...
        B1[1]=40.58565075993
        ;
        B1[2]=41.1624532320408
        ;
        B1[3]=42.1548243938528
        ;
        B1[4]=38.7116257214674
        ;

        //ınv-t_pos
        B2[0]=0;
        B2[1]=10.119101478693
        ;
        B2[2]=8.92525122817664
        ;
        B2[3]=5.75933871946846
        ;
        B2[4]=5.05360060790208
        ;

        //ınv-t_pos^2
        B3[0]=0;
        B3[1]=-0.0536447106693376
        ;
        B3[2]=-0.0650608737883945
        ;
        B3[3]=-0.0283914497234849
        ;
        B3[4]=-0.0832390299201682
        ;
        //ınv-t_neg
        B4[0]=0;
        B4[1]=-4.93085277795323
        ;
        B4[2]=-29.5097175410428
        ;
        B4[3]=-57.4969957536137
        ;
        B4[4]=-64.2727588702271
        ;

        //ınv-t_neg^2
        B5[0]=0;
        B5[1]=1.54755742610333
        ;
        B5[2]=0.914509145943977
        ;
        B5[3]=0.249904591052154
        ;
        B5[4]=0.249754051143361
        ;
        ...
        PrintWriter Solution= new PrintWriter("Integrated_reg_progression_ver4_for_case_"+case_number+".csv");
        arr = SimulationMatrix(period, m, alphaSimulation, lambdaSimulation, unitCost, fixedCost, retailPrice, returnCredit, holdingCost, backorderCost, salvageValue,nresult ,S, sl, s, alpha, lambda, BigM, MM,  poissonDistProbability, binomialDistProbability,B0,B1,B2,B3,B4,B5,Solution);
