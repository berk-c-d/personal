...
public class adp_v3_21122022 {
    ...
    */
        ...
        String csvFile = "C:\\Users\\berkc\\Desktop\\All Results-2\\Regression Results\\Results for all periods_version_BASECASE.csv";
...
/*
        ADP_Iteration[1] =  ADPMatrix(period, m, alphaSimulation, lambdaSimulation, unitCost, fixedCost,
                    retailPrice, returnCredit, holdingCost, backorderCost, salvageValue,nresult ,S,sl,
                    s, alpha, lambda, BigM, MM,  poissonDistProbability, binomialDistProbability,
                    ADP_BetaAndB[0],nBeta, nn);

        ADP_Iteration2[1]=ADP_Iteration[1];
	 ...
	 while (nnn < N ) {
		 ...
		 ADP_Iteration2[0]=ADP_Iteration2[1];



		 ADP_Iteration2[1] = ADPMatrix(period, m, alphaSimulation, lambdaSimulation, unitCost, fixedCost,
	 	                    retailPrice, returnCredit, holdingCost, backorderCost, salvageValue,nresult ,S,sl,
	 	                    s, alpha, lambda, BigM, MM,  poissonDistProbability, binomialDistProbability,
	 	                    ADP_BetaAndB[nnn-1],nBeta, nn);
	 ...
	 ADP_BetaAndB[N] =ADP_Iteration2[1] ;
    ...
    public static double[][][][] ADPMatrix(int period, int m, double alphaSimulation, double lambdaSimulation, int unitCost, int fixedCost,
        ...
        for (int i = 0; i < s; i++) { //S up to order
            ...
            for (int jj = 0; jj <= m; jj++) { //demand
                ...
                double reg_result=ADP_BetaAndB[0][0][0][0] +ADP_BetaAndB[0][0][0][1]*prev_sale +ADP_BetaAndB[0][0][0][2]*inv_min_brk_point_pos
                        +ADP_BetaAndB[0][0][0][3]*inv_min_brk_point_pos_sqr+ADP_BetaAndB[0][0][0][4]*inv_min_brk_point_neg
                        +ADP_BetaAndB[0][0][0][5]*inv_min_brk_point_neg_sqr;
            ...
            for (int i_ = 0; i_ < s; i_++) { //S up to order
                ...
                for (int jj_ = 0; jj_ <= m; jj_++) { //demand
                    ...
                    for (int k_ = 0; k_ <=SL[i-1] ; k_++) {
                        ...
                        double inv_min_brk_point_pos_sqr=inv_min_brk_point_pos*inv_min_brk_point_pos;
                        double inv_min_brk_point_neg_sqr=inv_min_brk_point_neg*inv_min_brk_point_neg;
                        double reg_result=ADP_BetaAndB[0][i][0][0] +ADP_BetaAndB[0][i][0][1]*prev_sale +ADP_BetaAndB[0][i][0][2]*inv_min_brk_point_pos
                                +ADP_BetaAndB[0][i][0][3]*inv_min_brk_point_pos_sqr+ADP_BetaAndB[0][i][0][4]*inv_min_brk_point_neg
                                +ADP_BetaAndB[0][i][0][5]*inv_min_brk_point_neg_sqr;
