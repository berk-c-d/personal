...
/*                  ------------------------------------------------------------------------
	...
	*/
            ...
            //--------------------------------------------------------Z matrisi artık kullanılmadığı için period indexi silindi
            ...
            //double[][] Z = new double[n][sl]; //Z denotes profit to go.----Her periyotta, her bir inventory seviyesi ve order upto level için profit değeri----------------
            //Z = ZEndcalculate(I, period, n,sl, m, alpha, unitCost, salvageValue, retailPrice, returnCredit, fixedCost,unitCost, binomialDistProbability);
            ...
            /*for (int p = period - 1; p >= 0; p--) {   ///İÇERİDE Z KULLANILIYOR !!!!!!!!!!!!!
                if (p + 1 == period) {
                    Z_bigSDouble[p] = periodMatrixmodifiedv3(I, S, period, Z, J, n, sl, s, m, alpha, lambda, unitCost, fixedCost, retailPrice, returnCredit, holdingCost, backorderCost, BigM, MM, M, poissonDistProbability, binomialDistProbability);
                }
                else{Z_bigSDouble[p] = periodMatrixmodifiedv3(I, S, period, Z_bigSDouble[p + 1][0], J, n, sl, s, m, alpha, lambda, unitCost, fixedCost, retailPrice, returnCredit, holdingCost, backorderCost, BigM, MM, M, poissonDistProbability, binomialDistProbability);
            }}*/

            for (int p = period - 1; p >= 0; p--) {
                Z_bigSDouble[p] = periodMatrixmodifiedv3(I, S, period, Z_bigSDouble[p + 1][0], J, n, sl, s, m, alpha, lambda, unitCost, fixedCost, retailPrice, returnCredit, holdingCost, backorderCost, BigM, MM, M, poissonDistProbability, binomialDistProbability);
            }
            ...
            for (int p = period - 1; p >= 0; p--) {
                Z_bigSDoubleC[p]=periodMatrixmodifiedv3(I, S,period, Z_bigSDoubleC[p + 1][0],JC, n, sl, s, m, alphaC, lambdaC, unitCost, fixedCost, retailPrice, returnCredit, holdingCost, backorderCost, BigM, MM, M, poissonDistProbabilityC,binomialDistProbabilityC);
            }
